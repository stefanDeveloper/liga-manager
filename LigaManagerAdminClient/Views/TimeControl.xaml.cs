    ...
    public partial class TimeControl : UserControl
    {
        ...
        public DateTime? DateTimeValue
        {
            get
            {
                ...
                {
                    string value = string.Format("{0}:{1}", TxtHours.Text, TxtMinutes.Text);
                    DateTime time = DateTime.Parse(value);
                    return(DateTime)GetValue(StateProperty);
                }
                else
                {
                    return null;
            ...
            set
            {
                ...
                if (time.HasValue)
                {
                    ...
                    if (values.Length == 2)
                    {
                        TxtHours.Text = values[0];
                        TxtMinutes.Text = values[1];
        ...
        public static readonly DependencyProperty StateProperty = DependencyProperty.Register(
            "DateTimeValue", typeof(DateTime), typeof(TimeControl), new PropertyMetadata(DateTime.Now));
        ...
        public TimeSpan? TimeSpanValue
        {
            ...
            set
            {
                ...
                {
                    DateTimeValue = new DateTime(timeSpan.Value.Ticks);
                }
            }
        }
        ...
        {
            int value = Convert.ToInt32(TxtHours.Text);
            if (isUp)
            {
                value += 1;
                if (value == 24)
            ...
            TxtHours.Text = Convert.ToString(value);
        }
        ...
        {
            int value = Convert.ToInt32(TxtMinutes.Text);
            if (isUp)
            {
                value += 1;
                if (value == 60)
